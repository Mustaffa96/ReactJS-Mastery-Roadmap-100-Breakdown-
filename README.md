...
* **JavaScript Essentials (10%):**
  * ES6+ syntax: arrow functions, destructuring, spread/rest operators, modules (import/export).
...
* **Web Development Basics (10%):**
  ...
  * CSS: Flexbox, Grid, responsive design, CSS-in-JS basics.
